/*
  ---------------------------------------------------------------------------
  Reflow Master Control - v2.03 - 01/03/2021.
  ...
  01/03/2021 v2.03  - Added Chipquick TS391AX paste profile
                    - Adjusted SETTINGS_PASTE to fit 6 profiles in to screen
                    - Adjusted cursor movement on SETTINGS_PASTE screen
  ---------------------------------------------------------------------------
*/
...
void LoadPaste()
{
  ...
  */
  ...
  solderPaste[5] = ReflowGraph("CHIPQUICK TS391AX", "No Clean Sn63/Pb37 T4", 183, baseGraphX5, baseGraphY5, ELEMENTS(baseGraphX5));
